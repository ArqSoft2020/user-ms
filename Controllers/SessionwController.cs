...
namespace userService.Controllers
{
  ...
  [ApiController]
  public class SessionwController : ControllerBase
  {

    private readonly IUserRepository _userRepository;
    private readonly ISessionwRepository _sessionRepository;
    private IConfiguration _config;
    public SessionwController (IUserRepository userRepository, ISessionwRepository sessionwRepository, IConfiguration config)
    {
      _userRepository = userRepository;
      _sessionRepository = sessionwRepository;
      _config = config;
    }
